...
for file in file_list:
    ...
    command = 'python add_mask_one.py --image_path ' + data_storage_path + '/' + file + ' --face_lms_file ' + data_landmark_path + '/' + file_name + '_landmark0.txt' + ' --masked_face_path ' + data_mask_path + '/' + file_name + '_mask.jpg' + ' --template_name ' + template_name
    print(command)
    subprocess.call(command, shell=True)
